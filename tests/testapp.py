...
TEST_DEFAULTS = [
    ...
    ["internal", "github_url", "https://github.com/AlexanderGatesDev/biosimRust/"],
...
try:
    ...
    #_projconfig set to 'biosimrust.ini' at top of script
    # Try Rust config
    rust_config = biosimpath.joinpath("biosimrust.ini")
    cpp_config = biosimpath.joinpath("cpp", _projconfig)
    defaultconfigfile = rust_config if rust_config.exists() else cpp_config
...
if args.check:
    ...
    print("\nReport bugs to https://github.com/AlexanderGatesDev/biosimRust/\n")
    exit(0)
